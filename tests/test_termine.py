...
def test_der_erste_termin_ist_der_erste_nicht_abgesagte():
    eintrag = _eintrag(wiederholung="weekly", exceptions={"2026-09-16": None, "2026-09-23": None})
    assert termine.erster_termin(eintrag) == date(2026, 9, 30)
    assert termine.erster_termin({**eintrag, "until": "2026-09-30"}) is None
